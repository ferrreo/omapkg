...
<main class="public-main">
  <article class="section site-width--narrow" aria-labelledby="security-title">
    ...
    <div class="detail-stack">
      ...
      <section class="workbench-panel"><div class="workbench-panel__head"><h2>Evidence limits</h2><Icon name="eye" size={18} /></div><p class="prose">Signatures authenticate build claims and release decisions; they do not prove software harmless. An SBOM inventories declared and resolved components, not a complete runtime dependency closure. Dynamic loading, plugins, subprocesses, and data paths can remain unknown. Published recipes execute on your machine, outside hosted worker isolation.</p></section>
    </div>
  </article>
