...
export type RequestStatus = 'pending' | 'generating' | 'review' | 'queued' | 'building' | 'built' | 'failed' | 'rejected' | 'blocked';
...
export interface Release {
  ...
  recipe_key: string; sbom_key: string; provenance_key: string; attestation_key?: string | null; published_at: number;
