...
const DENIED_REASONS = new Map([
  [400, 'bad_request'], [401, 'unauthorized'], [403, 'forbidden'], [404, 'not_found'],
  [405, 'method_not_allowed'], [409, 'conflict'], [410, 'gone'], [411, 'length_required'],
  [412, 'precondition_failed'], [413, 'payload_too_large'], [415, 'unsupported_media_type'],
  [422, 'unprocessable_entity'], [429, 'rate_limited'],
]);
...
export function deniedReason(status: number): string {
  return DENIED_REASONS.get(status) ?? `http_${status}`;
}
