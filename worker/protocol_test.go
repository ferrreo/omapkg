...
func TestDaemonMetadataIsFixedAndIndependent(t *testing.T) {
	...
	want := []string{"offline-oci", "multipart-upload", "registry-pull", "runtime-analysis-v1", "multi-output-v2", "frozen-inputs-v1", "helper-shell-analysis-v1", "recipe-inspection-v1", "preserved-recipe-v1", "abi-inventory-v1", "single-build-reproducibility-v1"}
