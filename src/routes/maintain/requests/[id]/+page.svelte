<script lang="ts">
  ...
  type DescribedRevision = Revision & { description?: string | null; recipePolicy?: { mode: string; recorded: boolean }; runtimeExceptions?: Array<{ findingSha256: string; reason: string }> };
