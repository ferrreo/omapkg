...
const text = v.pipe(v.string(), v.trim(), v.minLength(1), v.maxLength(2000), v.check((value) => [...value].every((character) => character > '\u001f' && character !== '\u007f'), 'Control characters are not allowed.'));
